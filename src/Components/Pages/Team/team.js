...
export default function Team() {
    ...
    const teamCard = [
        ...
        },
        {
            ...
            link: "kuldeep-bhangu",
            detail: "UI Designer",
            info: '"I have done my bachelor\'s in Computer Applications. I enjoy spending my time on designing and always have a positive and flexible attitude towards others."',
